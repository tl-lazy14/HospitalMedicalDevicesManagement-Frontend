...
const ModalCreateUsageRequest = ({ isModalOpen, setIsModalOpen, updateListUsageRequest, user }) => {
    ...
    const handleAddRequest = async () => {
        if (
            ...
            toast.error('Vui lòng nhập đầy đủ các trường thông tin', {
                ...
                containerId: "validationCreateUsageRequest",
                autoClose: 3000,
        ...
        try {
            const response = await api.post('/usage/request/create', newRequest, {
    ...
    return (
        <>
            <ToastContainer containerId="validationCreateUsageRequest" limit={1}/>
            <Modal 
                isOpen={isModalOpen}
...
export default ModalCreateUsageRequest;